        ...
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                ...
                this.$container.append(
                    "\n\t\t\t<div id='bonzi_" +
                        this.id +
                          "' class='bonzi'>\n\t\t\t\t<div class='bonzi_status' style='display:none'></div><div class='bonzi_user'></span><span class='bonzi_name'></span> <span class='typing' hidden>is typing...</span></div>\n\t\t\t\t\t<div class='bonzi_placeholder'></div>\n\t\t\t\t<div style='display:none' class='bubble'>\n\t\t\t\t\t<p class='bubble-content'></p>\n\t\t\t\t<div class='close-bubble'><i class='fas fa-times' /></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t"
                                        ),
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"),
                            this.stopSpeaking(),
                            (this.goingToSpeak = !0);
                            let url = "//www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(a) + "&voice=" + encodeURIComponent("Adult Male #3, American English (TruVoice)") + "&pitch=115&speed=150";
