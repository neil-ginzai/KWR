        ...
        socket.on("replaceTVWithURL", function(a) {
          ...
          socket.on("room", function(a) {
              if (a.room == "news") {
                  ...
                  $("#room_info").append("<br><font color='red'><h3>BonziTV is an early development and is also a work in progress project. Expect bugs!<br>Report any bugs to the Discord or DM Seamus.</h3></font>")
...
var _createClass = (function () {
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "KinitoPET", color: "pink", speed: 175, pitch: 50, voice: "en-us" }),
                                    ...
                                    items:{
                                      ...
                                      pastule: {
                                        ...
                                        behh: {
                                              ...
                                              callback: function () {
                                                  socket.emit("command", { list: ["nigger", d.userPublic.name] });
                                              },
                                          },
                                      asktokys: {
                                          name: "Ask to KYS",
        ...
        return (
            _createClass(a, [
                ...
                $.contextMenu({
                  ...
                  items: {
                    ...
                    espeak: {
                      name: "Toggle Espeak",
                      callback: function () { espeaktts = !espeaktts; if (espeaktts = false) { SAPI4 = true } else if (espeaktts = true) { SAPI4 = false } }
                    },
                    settings: function(){
                      const obj = {};
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                          ...
                          document.getElementById("chat_log_list").innerHTML += "<p><span class=\"bonzi-name ng-isolate-scope\"><span class=\"event-source ng-binding ng-scope\"><b><i><font color='"+this.userPublic.color+"'>"+this.userPublic.name+": </font></i></span></b><span class=\"body ng-binding ng-scope\" style=\"color:#dcdcdc;\">"+a+"</span></p>",                      document.getElementById("chat_log_list").scrollTop = document.getElementById("chat_log_list").scrollHeight,
                            (a = linkify(a));
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"),
                            ...
                            (this.goingToSpeak = !0);
                            if (SAPI4 === true) { 
                                let url = "//www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(a) + "&voice=" + encodeURIComponent("Adult Male #3, American English (TruVoice)") + "&pitch=" + this.userPublic.pitch + "&speed="+ this.userPublic.speed;
                ...
                },
            {
                ...
                },
                {
                    key: "nigger",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "Kill yourself. Behead yourself. Roundhouse kick yourself into the concrete. Slam dunk a yourself into the trashcan. Crucify filthy blacks. Defecate in a yourself food. Launch yourself into the sun. Stir fry yourself in a wok. Toss yourself into active volcanoes. Urinate into a yourself gas tank. Judo throw yourself into a wood chipper. Twist yourself heads off. Report yourself to the IRS. Karate chop yourself in half. Curb stomp pregnant black yourself. Trap yourself in quicksand. Crush yourself in the trash compactor. Liquefy yourself in a vat of acid. Eat yourself. Dissect yourself. Exterminate yourself in the gas chamber. Stomp nigger skulls with steel toed boots. Cremate yourself in the oven. Lobotomize yourself. Mandatory abortions for yourself. Grind nigger fetuses in the garbage disposal. Drown yourself in fried chicken grease. Vaporize yourself with a ray gun. Kick old yourself down the stairs. Feed yourself to alligators. Slice yourself with a katana.", say: "Kill yourself. Behead yourself. Roundhouse kick a nigger into the concrete. Slam dunk a nigger baby into the trashcan. Crucify filthy blacks. Defecate in a yourself food. Launch yourself into the sun. Stir fry yourself in a wok. Toss yourself into active volcanoes. Urinate into a yourself gas tank. Judo throw yourself into a wood chipper. Twist yourself heads off. Report yourself to the IRS. Karate chop yourself in half. Curb stomp pregnant black yourself. Trap yourself in quicksand. Crush yourself in the trash compactor. Liquefy yourself in a vat of acid. Eat yourself. Dissect yourself. Exterminate yourself in the gas chamber. Stomp nigger skulls with steel toed boots. Cremate yourself in the oven. Lobotomize yourself. Mandatory abortions for yourself. Grind nigger fetuses in the garbage disposal. Drown yourself in fried chicken grease. Vaporize yourself with a ray gun. Kick old yourself down the stairs. Feed yourself to alligators. Slice yourself with a katana." }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "regret",
                    value: function (a) {
                        this.runSingleEvent([{ type: "anim", anim: "sad_fwd", ticks: 15 },
                      { type: "text", text: "What the Actually fuck is happening with me on the internet?", say: "What the Actually fuck is happening with me on the internet?" }, 
                                             { type: "text", text: "Why a lot of people likes me.", say: "Why a lot of people likes me." }, 
                                             { type: "text", text: " I am a fucking axototl with legs? Just why.", say: "I am a fucking axototl with legs? Just why." }, 
                                             { type: "idle" }]);
                    },
                },
                {
    ...
    BonziData = {
        ...
        event_list_joke_open: [
            ...
            [{ type: "text", text: "THE FOLLOWING JOKE MAY OFFEND PEOPLE. IF YOU'RE OFFENDED, PLEASE GO TO GOATSE.INFO" }],
        ...
        event_list_fact_open: [[{ type: "html", text: "HEY YOU IDIOTS IT'S TIME FOR THE FUN FACT", say: "hey you idiots its time for the fun fact" }]],
        event_list_fact_mid: [
            [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you know that objectfags should kill itself, and commit suicide?", say: "Did you know that objectfags should kill itself, and commit suicide?" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Pornfags should die, Just like their father.", say: "Pornfags should die, Just like their father." },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "text", text: "Fun Fact: The skript kiddie of this site didn't bother checking if the text that goes into the dialog box is HTML code. (EARRAPE WARNING!)", say: "Fun Fact: The skript kiddie of this site didn't bother checking if the text that goes into the dialog box is HTML code."},
                { type: "html", text: "<img src='./img/misc/topjej.png'></img>", say: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA! [[" },
                { type: "text", text: "What the fuck! Stop screaming you little shit!" },
                { type: "html", text: "<img src='./img/misc/topjej.png'></img>", say: "AAAAAAAALALAKAKASAKASAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA! [[" },
            ],
        ],
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_linux = [
        { type: "text", text: "I'd just like to interject for a moment. What you’re referring to as Linux, is in fact, KINITO/Linux, or as I’ve recently taken to calling it, KINITO plus Linux." },
        {
            type: "text",
            text:
                "Linux is not an operating system unto itself, but rather another free component of a fully functioning KINITO system made useful by the KINITO corelibs, shell utilities and vital system components comprising a full OS as defined by M.A.L.W.A.R.E.",
        },
        {
            type: "text",
            text:
                "Many computer users run a modified version of the KINITO system every day, without realizing it. Through a peculiar turn of events, the version of KINITO which is widely used today is often called “Linux”, and many of its users are not aware that it is basically the KINITO system, developed by the KINITO Project.",
        },
        {
            type: "text",
            text:
        ...
        { type: "text", text: "The kernel is an essential part of an operating system, but useless by itself; it can only function in the context of a complete operating system, such as systemd." },
        {
            type: "text",
            text:
                "Linux is normally used in combination with the KINITO operating system: the whole system is basically KINITO with Linux added, or KINITO/Linux. All the so-called “Linux” distributions are really distributions of KINITO/Linux.",
        },
    ]),
    (BonziData.event_list_pawn = [
        {
            type: "text",
            text:
                "Hi, my name is KinitoPET, and this is my website. I meme here with my old harambe, and my son, Clippy. Everything in here has an ad and a fact. One thing I've learned after 17 years - you never know what is gonna give you some malware.",
        },
    ]),
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["blue", "green", "purple", "red", "pink", "pope"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlue", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "topjej"];
