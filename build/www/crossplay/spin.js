(function(a, b, c) {
  ...
  function j(a, b, c, d) {
      var g = ["opacity", b, ~~(a * 100), c, d].join("-")
        ...
        , l = k && "-" + k + "-" || "";
      return e[g] || (i.insertRule("@" + l + "keyframes " + g + "{" + "0%{opacity:" + j + "}" + h + "%{opacity:" + a + "}" + (h + .01) + "%{opacity:1}" + (h + b) % 100 + "%{opacity:" + a + "}" + "100%{opacity:" + j + "}" + "}", 0),
      e[g] = 1),
      g
  }
  function k(a, b) {
  ...
  m(p.prototype, {
      spin: function(a) {
          ...
          a && (a.insertBefore(d, a.firstChild || null),
          i = n(a),
          h = n(d),
          l(d, {
  ...
  !function() {
      ...
      !k(b, "transform") && b.adj ? (i.addRule(".spin-vml", "behavior:url(#default#VML)"),
